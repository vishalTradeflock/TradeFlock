...
const SOCIAL_LINKS = [
  ...
  },
  {
    ...
    iconClass: "h-4 w-4 fill-current",
...
export default function Footer() {
  return (
    <footer className="mt-10 border-t border-neutral-200 bg-white">
      <div className="mx-auto grid max-w-[1240px] items-start gap-8 px-4 py-8 sm:grid-cols-2 lg:grid-cols-4">
        <div>
        ...
        <nav aria-label="Follow">
          <h4 className="text-[11px] font-mono uppercase tracking-widest text-muted-foreground">
            FOLLOW
          </h4>
          <div className="mt-2 flex items-center gap-3.5">
            {SOCIAL_LINKS.map((link) => (
              <a
                ...
                title={link.label}
                className={`text-neutral-500 transition-colors duration-150 ${link.hoverClass}`}
              >
